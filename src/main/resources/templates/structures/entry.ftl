		...
		<div class="entryNew_content">
			<nav class="entryNav">
				<ol class="entryNav_ol">
					...
					<li><a href="#grab">Glycan RDF Association Browser(GRAB)</a></li>
...
<!-- 				<section id="structure" class="entryNew_section">
 ...
 -->				<section id="grab" class="entryNew_section">
					<h1 class="entryNew_heading">Glycan RDF Association Browser(GRAB)</h1>
				...
				<section id="literature" class="entryNew_section">
					...
					<h2 class="entryNew_heading entryNew_heading-2nd"><a href="/Registries/supplement/${accNum}">Register your Publication!</a></h2>
